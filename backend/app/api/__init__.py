...
neurosim_bp = Blueprint('neurosim', __name__)
...
@neurosim_bp.before_request
def protect_neurosim():
    return verify_auth()
...
from . import neurosim  # noqa: E402, F401 - NeuroSim A/B testing pipeline
from . import pr_crisis  # noqa: E402, F401 - PR Crisis Simulation API
