...
const features = [
  ...
  },
  {
    ...
    color: 'text-emerald-400', border: 'border-emerald-400/20', bg: 'bg-emerald-400/5',
  },
  {
  ...
  return (
    <div className="bg-neural neural-grid min-h-screen">
      <div className="relative z-10">
            ...
            <div className="md:col-span-7">
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-400/10 border border-cyan-400/20 mb-8">
                  ...
                  <span className="text-[11px] font-mono text-cyan-400 tracking-[0.15em] uppercase">Predictive Content Intelligence</span>
                </div>
                ...
                <div className="flex items-center gap-4">
                  {isSignedIn ? (
                    <button onClick={() => router.push('/dashboard')} className="group inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-cyan-400/10 border border-cyan-400/25 text-cyan-300 font-semibold text-sm hover:bg-cyan-400/20 transition-all">
                      <span>Go to Dashboard</span>
                      <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                    </button>
                  ) : (
                    <button onClick={handleAuth} className="group inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-cyan-400/10 border border-cyan-400/25 text-cyan-300 font-semibold text-sm hover:bg-cyan-400/20 transition-all">
                      <span>Start Analyzing Free</span>
                      <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                    </button>
                  )}
                  <a href="#features" className="px-8 py-3.5 rounded-xl border border-white/10 text-gray-400 font-medium text-sm hover:text-white hover:border-white/20 transition-all">
                    See Features
                  </a>
                </div>

                <p className="text-xs text-gray-500 mt-5 font-mono tracking-wide">No credit card &middot; Free tier includes 10 analyses per month</p>
              </motion.div>
            </div>
            ...
            <div className="md:col-span-5">
              ...
              >
                ...
                <div className="relative aspect-[4/3] rounded-2xl border border-white/[0.06] bg-white/[0.015] overflow-hidden">
                  ...
                  {/* Scan line sweep */}
                  <motion.div
                    className="absolute inset-x-0 h-px bg-gradient-to-r from-transparent via-cyan-400/60 to-transparent z-10"
                    initial={{ top: '0%' }}
                    animate={{ top: ['0%', '100%', '0%'] }}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <motion.div
                      className="w-48 h-48 rounded-full border border-cyan-400/20"
                      animate={{ scale: [1, 1.08, 1], opacity: [0.3, 0.6, 0.3] }}
                      transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}
                    />
                    <motion.div
                      className="absolute w-36 h-36 rounded-full border border-purple-400/15"
                      animate={{ scale: [1.08, 1, 1.08], opacity: [0.2, 0.5, 0.2] }}
                      transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }}
                    />
                    <motion.div
                      className="absolute w-24 h-24 rounded-full bg-cyan-400/8 blur-xl"
                  ...
                  {/* Center icon */}
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-16 h-16 rounded-2xl bg-cyan-400/10 border border-cyan-400/20 flex items-center justify-center backdrop-blur-sm">
                  ...
                  <div className="absolute top-4 right-4 flex flex-col items-end gap-1">
                    ...
                    <span className="text-xs font-mono text-cyan-400/60">0.72</span>
                  </div>
                  <div className="absolute bottom-4 right-4 flex items-center gap-1">
                    <span className="text-[10px] font-mono text-gray-600">threshold</span>
                    <span className="text-[10px] font-mono text-cyan-400/40">0.4</span>
                  </div>
                </div>
              </motion.div>
            </div>
        ...
        <section id="features" className="max-w-7xl mx-auto px-6 py-24 md:py-32">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.03] border border-white/[0.06] mb-6">
              ...
              <span className="text-[10px] font-mono text-cyan-400/60 tracking-[0.15em] uppercase">Instrumentation</span>
            </div>
              ...
              >
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-4 text-[11px] font-mono text-cyan-400/50 group-hover:text-cyan-400/80 transition-colors">
        ...
        <section id="pipeline" className="max-w-5xl mx-auto px-6 py-24 md:py-32">
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.03] border border-white/[0.06] mb-6">
              ...
              <span className="text-[10px] font-mono text-purple-400/60 tracking-[0.15em] uppercase">Pipeline</span>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-0 relative">
            ...
            <div className="hidden md:block absolute top-12 left-[calc(16.66%+24px)] right-[calc(16.66%+24px)] h-px bg-gradient-to-r from-cyan-400/30 via-purple-400/30 to-cyan-400/30" />
            ...
            {[
              ...
              >
                <div className="w-12 h-12 rounded-full bg-cyan-400/10 border border-cyan-400/20 flex items-center justify-center mb-5 z-10 relative">
                  <span className="text-lg font-bold font-mono text-cyan-400">{s.num}</span>
                </div>
            ...
            {plans.map((p, i) => (
              <motion.div
                ...
                className={`relative rounded-2xl p-8 flex flex-col ${
                  p.popular
                    ? 'bg-gradient-to-b from-cyan-400/8 to-purple-400/5 border border-cyan-400/20 shadow-[0_0_40px_-8px_rgba(77,238,234,0.08)]'
                    : 'bg-white/[0.02] border border-white/[0.06]'
                }`}
              >
                {p.popular && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-5 py-1 rounded-full bg-gradient-to-r from-cyan-400/20 to-purple-400/20 border border-cyan-400/25 backdrop-blur-sm">
                    <span className="text-[10px] font-mono text-cyan-300 font-semibold tracking-[0.15em] uppercase">Most Capable</span>
                  </div>
                )}
                ...
                <ul className="space-y-3 mb-8 flex-1">
                  {p.items.map(item => (
                    <li key={item} className="flex items-start gap-3 text-sm text-gray-400">
                      <Check className={`w-4 h-4 ${p.popular ? 'text-purple-400' : 'text-cyan-400'} mt-0.5 flex-shrink-0`} />
                      {item}
                    </li>
                  ))}
                </ul>
                <button
                  ...
                  className={`w-full py-3 rounded-xl text-sm font-semibold transition-all ${
                    p.popular
                      ? 'bg-gradient-to-r from-cyan-400/15 to-purple-400/15 border border-cyan-400/25 text-cyan-300 hover:from-cyan-400/25 hover:to-purple-400/25'
                      : 'bg-cyan-400/10 border border-cyan-400/25 text-cyan-300 hover:bg-cyan-400/20'
        ...
        <section className="max-w-5xl mx-auto px-6 pb-32">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-cyan-400/8 via-purple-400/5 to-cyan-400/8 border border-cyan-400/15 rounded-3xl" />
            ...
            <div className="relative px-8 py-16 md:px-16 md:py-20 text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-400/10 border border-cyan-400/15 mb-6">
                <Sparkles className="w-3 h-3 text-cyan-400" />
                <span className="text-[10px] font-mono text-cyan-400/60 tracking-[0.15em] uppercase">Ready</span>
              </div>
